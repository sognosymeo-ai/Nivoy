...
import ProductTour, { type Onglet } from "@/components/ProductTour";
import {
  IconUpload,
  IconDocument,
  IconSearch,
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">
        4 à 5&nbsp;% du chiffre d&apos;affaires jamais facturé<sup className="text-sm font-normal text-indigo-600">1</sup>
      </h2>
      <p className="mt-3 text-slate-600">
        Un jour non facturé passe inaperçu. Répété sur plusieurs missions, l&apos;addition devient
        réelle — sans qu&apos;aucune alerte ne se déclenche.
      </p>
      ...
      <p className="mt-6 text-xs text-slate-400">
        1&nbsp;Benchmarks SPI Research (Service Performance Insight) sur les sociétés de services
        professionnels : 4,05&nbsp;% en 2015, 4,3&nbsp;% en 2016, 4,26&nbsp;% en 2021, ~4,5&nbsp;%
        en 2026. Illustration à partir des moyennes du secteur, pas une estimation de vos pertes.
      </p>
    </div>
  );
}

function PanneauCommentCaMarche() {
  return (
    <div>
      <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">Trois étapes, un résultat net</h2>
...
function PanneauFonctionnalites() {
  return (
    <div>
      <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">
...
function PanneauTarifs() {
  return (
    <div>
      <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">Un tarif simple</h2>
      <p className="mt-1 text-sm text-slate-500">Tarifs indicatifs.</p>
...
function PanneauFaq() {
  return (
    <div>
      <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">Questions fréquentes</h2>
...
const onglets: Onglet[] = [
  { id: "probleme", label: "Le problème", icon: <IconScale />, contenu: <PanneauProbleme /> },
  { id: "comment", label: "Comment ça marche", icon: <IconSparkle />, contenu: <PanneauCommentCaMarche /> },
  { id: "fonctionnalites", label: "Détection", icon: <IconSearch />, contenu: <PanneauFonctionnalites /> },
  { id: "tarifs", label: "Tarifs", icon: <IconTag />, contenu: <PanneauTarifs /> },
  { id: "faq", label: "FAQ", icon: <IconQuestion />, contenu: <PanneauFaq /> },
];
